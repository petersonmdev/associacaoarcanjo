...
@section('content')
  <h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">{{ __('Configurações da minha conta') }} / </span>{{ __('Minha conta') }}</h4>
          ...
          <div class="card-body card-widget-separator">
            <div class="user-profile-header d-flex flex-column flex-lg-row text-sm-start text-center mb-8 p-3">
              <div class="flex-shrink-0 mt-1 mx-sm-0 mx-auto">
                <img src="{{ ($user->profile_photo_path) ? asset('uploads/'.$user->profile_photo_path) : asset('assets/img/avatars/avatar-default.png')}}" alt class="d-block h-auto ms-0 ms-sm-6 rounded-3 user-profile-img"/>
              </div>
                ...
                <div class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-5 flex-md-row flex-column gap-4">
                  <div class="user-profile-info">
                    ...
                    <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-4 mt-4">
                      ...
                      <li class="list-inline-item">
                        <i class="bx bx-save me-2 align-top"></i><span class="fw-medium">Cadastrado {{$user->created_at}}</span>
                      </li>
                    </ul>
                  </div>
              ...
              <div class="col-md-6 col-lg-6 col-12">
                <ul class="list-unstyled my-3 py-1">
                  <li class="d-flex align-items-center mb-4">
                    ...
                    <span class="fw-medium mx-2">{{ __('Criado em:') }}</span> <span>{{ $user->created_at }}</span>
                  </li>
                  <li class="d-flex align-items-center mb-2">
                    <i class="bx bx-up-arrow-circle"></i>
                    <span class="fw-medium mx-2">{{ __('Atualizado em:') }}</span> <span>{{ $user->updated_at }}</span>
                  </li>
                </ul>
              </div>
            </div>
