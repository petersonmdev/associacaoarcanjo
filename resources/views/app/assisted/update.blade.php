...
@section('title', "Editar " . ($assisted->name ?? 'família assistida'))

@section('content')
<h4 class="fw-bold py-3 mb-4"><span class="text-muted fw-light">Assistidos /</span> Editar família assistida</h4>
<div class="d-flex flex-wrap justify-content-between align-items-center mb-3">

  <div class="d-flex flex-column justify-content-center">
    <h4 class="mb-1 mt-3">Editar {{ $assisted->name ?? 'família assistida' }}</h4>
