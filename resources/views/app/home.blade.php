    ...
    <div class="col-lg-12 mb-4 order-0">
      <div class="card">
        <div class="d-flex align-items-end row">
          <div class="col-12">
            <div class="card-body">
              <h5 class="card-title text-primary">Bem vindo ao sistema de gestão {{config('variables.templateName')}} 🎉</h5>
              <p class="mb-4">Este sistema está sendo cuidadosamente desenvolvido para oferecer mais organização, clareza e eficiência na gestão das informações. Cada funcionalidade está sendo pensada para simplificar processos, reduzir retrabalho e gerar dados confiáveis para decisões mais assertivas.</p>
              <p class="mb-4">Estamos evoluindo continuamente a plataforma, implementando novos módulos e melhorias que ampliarão o controle, a transparência e a experiência de uso. Em breve, novas funcionalidades estarão disponíveis para tornar a gestão ainda mais completa e estratégica.</p>
            </div>
        </div>
      </div>
    </div>
