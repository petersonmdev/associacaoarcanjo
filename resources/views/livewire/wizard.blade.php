        ...
        <form class="form-repeater-dependents">
          <div class="row">
            @foreach($dependents as $index => $dependent)
              ...
              <div class="mb-3 col-md-6 col-xl-4 col-12">
                <label class="form-label" for="dependent-ocupation-{{$index}}">Ocupação</label>
                <input type="text" id="dependent-ocupation-{{$index}}" class="form-control @error('dependents.'.$index.'.dependent_ocupation') is-invalid @enderror" wire:model="dependents.{{$index}}.dependent_ocupation" placeholder="informe a ocupação">
                @error('dependents.'.$index.'.dependent_ocupation') <span class="d-block invalid-feedback">{{ $message }}</span> @enderror
              </div>
