<div>
  ...
  <div class="col-12">
    <div class="user-profile-header d-flex flex-column flex-lg-row text-sm-start text-center mb-6">
      <div class="flex-shrink-0 mt-1 mx-sm-0 mx-auto">
        <img src="{{ $profilePhotoPath ? asset('uploads/' . $profilePhotoPath) : asset('assets/img/avatars/avatar-default.png') }}" alt class="d-block h-auto ms-0 ms-sm-6 rounded-3 user-profile-img"/>
      </div>
      <div class="flex-grow-1 mt-3 mt-lg-5">
        <div class="d-flex align-items-md-end align-items-sm-start align-items-center justify-content-md-between justify-content-start mx-5 flex-md-row flex-column gap-4">
          <div class="user-profile-info">
            <h4 class="mb-2 mt-lg-7">{{ $authUser?->name ?? 'Usuário' }}</h4>
            <ul class="list-inline mb-0 d-flex align-items-center flex-wrap justify-content-sm-start justify-content-center gap-4 mt-4">
              ...
              <li class="list-inline-item">
                <i class='bx bx-envelope me-2 align-top'></i><span class="fw-medium">{{ $authUser?->email ?? '-' }}</span>
              </li>
            </ul>
          </div>
  ...
  <div class="col-12">
    ...
    <ul class="list-unstyled my-3 py-1">
      <li class="d-flex align-items-center mb-4"><i class="bx bx-user"></i><span class="fw-medium mx-2">Nome completo:</span> <span>{{ $authUser?->name ?? '-' }}</span></li>
