...
@section('content')
<h4 class="py-3 mb-4">
  <span class="text-muted fw-light">Configurações /</span> Minha conta
</h4>
      ...
      <div class="card-body">
        <div class="d-flex align-items-start align-items-sm-center gap-4">
          ...
          <div class="button-wrapper">
            ...
            <p class="text-muted mb-0">JPG, GIF ou PNG permitidos. Tamanho máximo de 1mb</p>
          </div>
        </div>
      </div>
      <hr class="my-0">
          ...
          <div class="row">
            ...
            <div class="mb-3 col-12 col-md-6">
              ...
              <div class="input-group input-group-merge">
                ...
                <input type="text" id="phoneNumber" name="phoneNumber" class="form-control" placeholder="(99)99999-9999" />
              </div>
            </div>
            <div class="mb-3 col-md-6">
              <label class="form-label" for="country">Função</label>
