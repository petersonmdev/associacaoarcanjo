        ...
        31936: function() {
          !function(e) {
            ...
            function r(t, s) {
              ...
              if (-1 !== e.inArray(l, s))
                return -1 === e.inArray(l, i) || Boolean(t.nodeValue.match(n) || t.nodeValue.match(o));
              for (var r = e(s).filter((function(e, t) {
            ...
            function g(e) {
              for (var t, i = [], s = e || v.call(this), n = 0, o = s.length; n < o; n++)
                (t = s[n]).disabled || i.push(void 0 === t.value ? t.text : t.value);
              return this.multiple ? i : i.length ? i[0] : null
            }
            p = null,
              Object.values = "function" == typeof Object.values ? Object.values : function(e) {
              ...
              ,
            String.prototype.startsWith || (d = {}.toString,
              h = function(e) {
                if (null == this)
                  throw new TypeError;
                var t = String(this);
                if (e && "[object RegExp]" == d.call(e))
                  throw new TypeError;
                var i = t.length
                  , s = String(e)
                  , n = s.length
            ...
            e.valHooks.select.set = function(t, i) {
              return i && !b.useDefault && e(t).data("selected", !0),
            ...
            function I(e, t, i, s) {
              for (var n = ["display", "subtext", "tokens"], o = !1, l = 0; l < n.length; l++) {
                ...
                s && (a = C(a)),
                  a = a.toUpperCase(),
                  o = "function" == typeof i ? i(a, t) : "contains" === i ? a.indexOf(t) >= 0 : a.startsWith(t)))
                  break
              }
              return o
            }
            ...
            e.fn.triggerNative = function(e) {
              var t, i = this[0];
              i.dispatchEvent && (k ? t = new Event(e,{
                bubbles: !0
            ...
            function C(e) {
              return (e = e.toString()) && e.replace(E, S).replace($, "")
            }
            var O, A, T, z, D, L = (O = {
                "&": "&amp;",
                "<": "&lt;",
              ...
              104: "8",
              105: "9"
            }, H = 27, M = 13, P = 32, W = 9, B = 38, R = 40, j = window.Dropdown || bootstrap.Dropdown;
            function U() {
              var t;
              try {
            ...
            function X(e, t) {
              e.length || (K.noResults.innerHTML = this.options.noneResultsText.replace("{0}", '"' + L(t) + '"'),
            ...
            var te = function(t, i) {
              var s = this;
              b.useDefault || (e.valHooks.select.set = b._set,
                b.useDefault = !0),
                this.$element = e(t),
            ...
            function ie(i) {
              ...
              if ([].shift.apply(n),
                ...
                try {
                  ...
                  te.BootstrapVersion ? V.full = te.BootstrapVersion.split(" ")[0].split(".") : (V.full = [V.major, "0", "0"],
              ...
              if (V.major >= "4") {
                var l = [];
                te.DEFAULTS.style === G.BUTTONCLASS && l.push({
                  name: "style",
                  className: "BUTTONCLASS"
                }),
                te.DEFAULTS.iconBase === G.ICONBASE && l.push({
                  name: "iconBase",
                  className: "ICONBASE"
                }),
                te.DEFAULTS.tickIcon === G.TICKICON && l.push({
                  name: "tickIcon",
                  className: "TICKICON"
                }),
              ...
              var a = this.each((function() {
                  ...
                  if (i.is("select")) {
                    var l = i.data("selectpicker")
                      , r = "object" == typeof o && o;
                    if (r.title && (r.placeholder = r.title),
                      l) {
                      if (r)
                        for (var a in r)
                          Object.prototype.hasOwnProperty.call(r, a) && (l.options[a] = r[a])
                    } else {
                      var d = i.data();
                      for (var h in d)
                        Object.prototype.hasOwnProperty.call(d, h) && -1 !== e.inArray(h, t) && delete d[h];
                      var p = e.extend({}, te.DEFAULTS, e.fn.selectpicker.defaults || {}, c(i), d, r);
                      p.template = e.extend({}, te.DEFAULTS.template, e.fn.selectpicker.defaults ? e.fn.selectpicker.defaults.template : {}, d.template, r.template),
                        p.source = e.extend({}, te.DEFAULTS.source, e.fn.selectpicker.defaults ? e.fn.selectpicker.defaults.source : {}, r.source),
            ...
            te.VERSION = "1.14.0-beta3",
              ...
              te.prototype = {
                ...
                init: function() {
                  ...
                  n && null === s.form && (n.id || (n.id = "form-" + this.selectId),
                  ...
                  void 0 !== i && this.$button.attr("data-id", i),
                    this.checkDisabled(),
                    this.clickListener(),
                  V.major > 4 && (this.dropdown = new j(this.$button[0])),
                  ...
                  s.hasAttribute("required") && this.$element.on("invalid" + F, (function() {
                      t.$button[0].classList.add("bs-invalid"),
                        t.$element.on("shown" + F + ".invalid", (function() {
                ...
                createDropdown: function() {
                  ...
                  var o, l = "", r = "", a = "", c = "", d = "";
                  return this.options.header && (l = '<div class="' + G.POPOVERHEADER + '"><button type="button" class="close" aria-hidden="true">&times;</button>' + this.options.header + "</div>"),
                  this.options.liveSearch && (r = '<div class="bs-searchbox"><input type="search" class="form-control" autocomplete="off"' + (null === this.options.liveSearchPlaceholder ? "" : ' placeholder="' + L(this.options.liveSearchPlaceholder) + '"') + ' role="combobox" aria-label="Search" aria-controls="' + this.selectId + '" aria-autocomplete="list"></div>'),
                ...
                createView: function(t, i, s) {
                  ...
                  if (this.selectpicker.isSearching = t,
                    ...
                    if (s)
                      ...
                      var l = n.$element[0]
                        , r = (l.options[l.selectedIndex] || {}).liIndex;
                      if ("number" == typeof r && !1 !== n.options.size) {
                        var c = n.selectpicker.main.data[r]
                          , d = c && c.position;
                        d && (o = d - (n.sizeInfo.menuInnerHeight + n.sizeInfo.liHeight) / 2)
                      }
                    }
                  function h(e, i) {
                    var s, o, l, r, c, d, p, u, f, m, v = n.selectpicker.current.data.length, g = [], b = !0, w = n.isVirtual();
                    n.selectpicker.view.scrollTop = e,
                      s = n.options.chunkSize,
                      o = Math.ceil(v / s) || 1;
                    for (var k = 0; k < o; k++) {
                      var I = (k + 1) * s;
                      if (k === o - 1 && (I = v),
                    ...
                    if (void 0 === c && (c = 0),
                      d = [n.selectpicker.view.position0, n.selectpicker.view.position1],
                      l = Math.max(0, c - 1),
                      r = Math.min(o - 1, c + 1),
                      n.selectpicker.view.position0 = !1 === w ? 0 : Math.max(0, g[l][0]) || 0,
                      n.selectpicker.view.position1 = !1 === w ? v : Math.min(v, g[r][1]) || 0,
                      p = d[0] !== n.selectpicker.view.position0 || d[1] !== n.selectpicker.view.position1,
                    void 0 !== n.activeElement && (i && (n.activeElement !== n.selectedElement && n.defocusItem(n.activeElement),
                      n.activeElement = void 0),
                    n.activeElement !== n.selectedElement && n.defocusItem(n.selectedElement)),
                    void 0 !== n.prevActiveElement && n.prevActiveElement !== n.activeElement && n.prevActiveElement !== n.selectedElement && n.defocusItem(n.prevActiveElement),
                    i || p || n.selectpicker.current.hasMore) {
                      if (u = n.selectpicker.view.visibleElements ? n.selectpicker.view.visibleElements.slice() : [],
                        n.selectpicker.view.visibleElements = !1 === w ? n.selectpicker.current.elements : n.selectpicker.current.elements.slice(n.selectpicker.view.position0, n.selectpicker.view.position1),
                        n.setOptionStatus(),
                      (t || !1 === w && i) && (f = u,
                        m = n.selectpicker.view.visibleElements,
                        b = !(f.length === m.length && f.every((function(e, t) {
                            return e === m[t]
                          }
                        )))),
                      (i || !0 === w) && b) {
                        var y, x, E = n.$menuInner[0], $ = document.createDocumentFragment(), S = E.firstChild.cloneNode(!1), C = n.selectpicker.view.visibleElements, O = [];
                        E.replaceChild(S, E.firstChild);
                        k = 0;
                        for (var A = C.length; k < A; k++) {
                          var T, z, D = C[k];
                          n.options.sanitize && (T = D.lastChild) && (z = n.selectpicker.current.data[k + n.selectpicker.view.position0]) && z.content && !z.sanitized && (O.push(T),
                            z.sanitized = !0),
                            $.appendChild(D)
                        }
                        if (n.options.sanitize && O.length && a(O, n.options.whiteList, n.options.sanitizeFn),
                          !0 === w ? (y = 0 === n.selectpicker.view.position0 ? 0 : n.selectpicker.current.data[n.selectpicker.view.position0 - 1].position,
                            x = n.selectpicker.view.position1 > v - 1 ? 0 : n.selectpicker.current.data[v - 1].position - n.selectpicker.current.data[n.selectpicker.view.position1 - 1].position,
                            E.firstChild.style.marginTop = y + "px",
                            E.firstChild.style.marginBottom = x + "px") : (E.firstChild.style.marginTop = 0,
                            E.firstChild.style.marginBottom = 0),
                          E.firstChild.appendChild($),
                        !0 === w && n.sizeInfo.hasScrollBar) {
                          var L = E.firstChild.offsetWidth;
                          if (i && L < n.sizeInfo.menuInnerInnerWidth && n.sizeInfo.totalMenuWidth > n.sizeInfo.selectWidth)
                            E.firstChild.style.minWidth = n.sizeInfo.menuInnerInnerWidth + "px";
                          else if (L > n.sizeInfo.menuInnerInnerWidth) {
                            n.$menu[0].style.minWidth = 0;
                            var N = E.firstChild.offsetWidth;
                            N > n.sizeInfo.menuInnerInnerWidth && (n.sizeInfo.menuInnerInnerWidth = N,
                              E.firstChild.style.minWidth = n.sizeInfo.menuInnerInnerWidth + "px"),
                    ...
                    if (n.prevActiveElement = n.activeElement,
                      n.options.liveSearch) {
                      if (t && i) {
                        var M, P = 0;
                        n.selectpicker.view.canHighlight[P] || (P = 1 + n.selectpicker.view.canHighlight.slice(1).indexOf(!0)),
                          M = n.selectpicker.view.visibleElements[P],
                          n.defocusItem(n.selectpicker.view.currentActive),
                          n.activeElement = (n.selectpicker.current.data[P] || {}).element,
                          n.focusItem(M)
                      }
                    } else
                ...
                fetchData: function(e, t, i, s) {
                  i = i || 1,
                    t = t || "data";
                  var n, o = this, l = this.options.source[t];
                  l ? (this.options.virtualScroll = !0,
                    "function" == typeof l ? l.call(this, (function(i, s, l) {
                        var r = o.selectpicker["search" === t ? "search" : "main"];
                        r.hasMore = s,
                          r.totalItems = l,
                          n = o.buildData(i, t),
                          e.call(o, n),
                          o.$element.trigger("fetched" + F)
                      }
                    ), i, s) : Array.isArray(l) && (n = o.buildData(l, t),
                      e.call(o, n))) : (n = this.buildData(!1, t),
                    e.call(o, n))
                },
                buildData: function(t, i) {
                  var s = this
                    , n = !1 === t ? J.fromOption : J.fromDataSource
                  ...
                  "search" === i && (r = this.selectpicker.search.data.length),
                  this.options.hideDisabled && (o += ":not(:disabled)");
                  var d = t ? t.filter(ee, this) : this.$element[0].querySelectorAll("select > *" + o);
                  function h(e) {
                    var t = l[l.length - 1];
                  ...
                  function p(i, o) {
                    ...
                    !0 === o.divider)
                      ...
                      o.optID && (p = "opt " + p),
                        o.optionClass = p.trim(),
                        o.inlineStyle = d,
                        o.text = n(i, "text"),
                        o.title = n(i, "title"),
                        o.content = n(i, "content"),
                        o.tokens = n(i, "tokens"),
                        o.subtext = n(i, "subtext"),
                        o.icon = n(i, "icon"),
                        o.display = o.content || o.text,
                        o.value = void 0 === i.value ? i.text : i.value,
                        o.type = "option",
                        o.index = a,
                        o.option = i.option ? i.option : i,
                        o.option.liIndex = a,
                        o.selected = !!i.selected,
                        o.disabled = o.disabled || !!i.disabled,
                      !1 !== t && (s.selectpicker.optionValuesDataMap[o.value] ? o = e.extend(s.selectpicker.optionValuesDataMap[o.value], o) : s.selectpicker.optionValuesDataMap[o.value] = o),
                        l.push(o)
                    }
                  }
                  function u(e, i) {
                    var s = i[e]
                      , r = !(e - 1 < c) && i[e - 1]
                      , d = i[e + 1]
                      , u = t ? s.children.filter(ee, this) : s.querySelectorAll("option" + o);
                    if (u.length) {
                      var f, m, g = {
                        display: L(n(v, "label")),
                        subtext: n(s, "subtext"),
                  ...
                  switch (i) {
                    case "data":
                      this.selectpicker.main.data || (this.selectpicker.main.data = []),
                        Array.prototype.push.apply(this.selectpicker.main.data, l),
                ...
                buildList: function(e, t) {
                  ...
                  function l(e, t) {
                    ...
                    t.element ? t.element.innerHTML = s.innerHTML : t.element = s,
                      e.push(t.element),
                  ...
                  !i.options.showTick && !i.multiple || K.checkMark.parentNode || (K.checkMark.className = this.options.iconBase + " " + i.options.tickIcon + " check-mark",
                    K.a.appendChild(K.checkMark));
                  for (var r = e || 0, a = s.length, c = r; c < a; c++) {
                    l(n, s[c])
                  }
                  e ? t ? Array.prototype.push.apply(this.selectpicker.search.elements, n) : (Array.prototype.push.apply(this.selectpicker.main.elements, n),
                    this.selectpicker.current.elements = this.selectpicker.main.elements) : t ? this.selectpicker.search.elements = n : this.selectpicker.main.elements = this.selectpicker.current.elements = n
                },
                findLis: function() {
                  return this.$menuInner.find(".inner > li")
                },
                render: function(e) {
                  var t, i, s = this, n = this.$element[0], o = this.setPlaceholder() && 0 === n.selectedIndex, l = v.call(this), r = l.length, c = g.call(this, l), d = this.$button[0], h = d.querySelector(".filter-option-inner-inner"), p = document.createTextNode(this.options.multipleSeparator), u = K.fragment.cloneNode(!1), f = !1;
                  ...
                  o && (o = 0 === n.selectedIndex)),
                    d.classList.toggle("bs-placeholder", s.multiple ? !r : !c && 0 !== c),
                  s.multiple || 1 !== l.length || (s.selectpicker.view.displayedValue = c),
                  "static" === this.options.selectedTextFormat)
                    u = Z.text.call(this, {
                      text: this.options.placeholder
                    }, !0);
                  else if ((t = this.multiple && -1 !== this.options.selectedTextFormat.indexOf("count") && r > 0) && (t = (i = this.options.selectedTextFormat.split(">")).length > 1 && r > i[1] || 1 === i.length && r >= 2),
                  !1 === t) {
                    if (!o) {
                      for (var m = 0; m < r && m < 50; m++) {
                        var b = l[m]
                          , w = {};
                        b && (this.multiple && m > 0 && u.appendChild(p.cloneNode(!1)),
                          b.title ? w.text = b.title : b.content && s.options.showContent ? (w.content = b.content.toString(),
                            f = !0) : (s.options.showIcon && (w.icon = b.icon),
                          s.options.showSubtext && !s.multiple && b.subtext && (w.subtext = " " + b.subtext),
                            w.text = b.text.trim()),
                    ...
                    var I = this.$element[0].querySelectorAll("select > option" + k + ", optgroup" + k + " option" + k).length
                      , y = "function" == typeof this.options.countSelectedText ? this.options.countSelectedText(r, I) : this.options.countSelectedText;
                    u = Z.text.call(this, {
                      text: y.replace("{0}", r.toString()).replace("{1}", I.toString())
                    }, !0)
                  }
                  ...
                  this.options.sanitize && f && a([u], s.options.whiteList, s.options.sanitizeFn),
                    h.innerHTML = "",
                    h.appendChild(u),
                  V.major < 4 && this.$newElement[0].classList.contains("bs3-has-addon")) {
                    var x = d.querySelector(".filter-expand")
                      , E = h.cloneNode(!0);
                    E.className = "filter-expand",
                      x ? d.replaceChild(E, x) : d.appendChild(E)
                  }
                ...
                liHeight: function(t) {
                  if (t || !1 !== this.options.size && !Object.keys(this.sizeInfo).length) {
                    var i, s = K.div.cloneNode(!1), n = K.div.cloneNode(!1), o = K.div.cloneNode(!1), l = document.createElement("ul"), r = K.li.cloneNode(!1), a = K.li.cloneNode(!1), c = K.a.cloneNode(!1), d = K.span.cloneNode(!1), h = this.options.header && this.$menu.find("." + G.POPOVERHEADER).length > 0 ? this.$menu.find("." + G.POPOVERHEADER)[0].cloneNode(!0) : null, p = this.options.liveSearch ? K.div.cloneNode(!1) : null, u = this.options.actionsBox && this.multiple && this.$menu.find(".bs-actionsbox").length > 0 ? this.$menu.find(".bs-actionsbox")[0].cloneNode(!0) : null, f = this.options.doneButton && this.multiple && this.$menu.find(".bs-donebutton").length > 0 ? this.$menu.find(".bs-donebutton")[0].cloneNode(!0) : null, m = this.$element[0].options[0];
                    ...
                    "auto" === this.options.width && (n.style.minWidth = 0),
                      ...
                      l.className = G.MENU + " inner " + (V.major >= "4" ? G.SHOW : ""),
                      ...
                      i = K.li.cloneNode(!1),
                        c.appendChild(d),
                        i.appendChild(c);
                    if (a.appendChild(d.cloneNode(!0)),
                    ...
                    var w, k = i.offsetHeight, I = a ? a.offsetHeight : 0, x = h ? h.offsetHeight : 0, E = p ? p.offsetHeight : 0, $ = u ? u.offsetHeight : 0, S = f ? f.offsetHeight : 0, C = e(r).outerHeight(!0), O = window.getComputedStyle(n), A = n.offsetWidth, T = {
                      vert: y(O.paddingTop) + y(O.paddingBottom) + y(O.borderTopWidth) + y(O.borderBottomWidth),
                      horiz: y(O.paddingLeft) + y(O.paddingRight) + y(O.borderLeftWidth) + y(O.borderRightWidth)
                    }, z = {
                      vert: T.vert + y(O.marginTop) + y(O.marginBottom) + 2,
                      horiz: T.horiz + y(O.marginLeft) + y(O.marginRight) + 2
                    };
                    o.style.overflowY = "scroll",
                      w = n.offsetWidth - A,
                      document.body.removeChild(s),
                      this.sizeInfo.liHeight = k,
                ...
                getSelectPosition: function() {
                  var t, i = this, s = e(window), n = i.$newElement.offset(), o = e(i.options.container);
                  i.options.container && o.length && !o.is("body") ? ((t = o.offset()).top += parseInt(o.css("borderTopWidth")),
                    t.left += parseInt(o.css("borderLeftWidth"))) : t = {
                    top: 0,
                    left: 0
                  };
                  var l = i.options.windowPadding;
                  this.sizeInfo.selectOffsetTop = n.top - t.top - s.scrollTop(),
                    this.sizeInfo.selectOffsetBot = s.height() - this.sizeInfo.selectOffsetTop - this.sizeInfo.selectHeight - t.top - l[2],
                    this.sizeInfo.selectOffsetLeft = n.left - t.left - s.scrollLeft(),
                    this.sizeInfo.selectOffsetRight = s.width() - this.sizeInfo.selectOffsetLeft - this.sizeInfo.selectWidth - t.left - l[1],
                    this.sizeInfo.selectOffsetTop -= l[0],
                    this.sizeInfo.selectOffsetLeft -= l[3]
                },
                setMenuSize: function(e) {
                  ...
                  "auto" === this.options.size)
                    n = this.selectpicker.current.data.length > 3 ? 3 * this.sizeInfo.liHeight + this.sizeInfo.menuExtras.vert - 2 : 0,
                ...
                setWidth: function() {
                  ...
                  "auto" === this.options.width ? requestAnimationFrame((function() {
                      e.$menu.css("min-width", "0"),
                        e.$element.on("loaded" + F, (function() {
                            e.liHeight(),
                              e.setMenuSize();
                ...
                selectPosition: function() {
                  ...
                  var t, i, s, n = this, o = e(this.options.container), l = function(l) {
                    var r = {}
                      , a = n.options.display || !!e.fn.dropdown.Constructor.Default && e.fn.dropdown.Constructor.Default.display;
                    n.$bsContainer.addClass(l.attr("class").replace(/form-control|fit-width/gi, "")).toggleClass(G.DROPUP, l.hasClass(G.DROPUP)),
                      t = l.offset(),
                      o.is("body") ? i = {
                        top: 0,
                        left: 0
                    ...
                    (V.major < 4 || "static" === a) && (r.top = t.top - i.top + s,
                      r.left = t.left - i.left),
                      r.width = l[0].offsetWidth,
                      n.$bsContainer.css(r)
                  };
                  this.$button.on("click.bs.dropdown.data-api", (function() {
                      n.isDisabled() || (l(n.$newElement),
                        n.$bsContainer.appendTo(n.options.container).toggleClass(G.SHOW, !n.$button.hasClass(G.SHOW)).append(n.$menu))
                    }
                  )),
                ...
                setSelected: function(e, t) {
                  ...
                  var i, s, n = e.element, o = void 0 !== this.activeElement, l = this.activeElement === n || t && !this.multiple && !o;
                  n && (void 0 !== t && (e.selected = t,
                  e.option && (e.option.selected = t)),
                  t && this.options.source.data && this.createOption(e, !1),
                    s = n.firstChild,
                  t && (this.selectedElement = n),
                    n.classList.toggle("selected", t),
                    l ? (this.focusItem(n, e),
                      this.selectpicker.view.currentActive = n,
                      this.activeElement = n) : this.defocusItem(n),
                  ...
                  l || o || !t || void 0 === this.prevActiveElement || (i = this.prevActiveElement,
                    this.defocusItem(i)))
                },
                setDisabled: function(e) {
                  ...
                  t && (V.major >= "4" && t.classList.toggle(G.DISABLED, i),
                ...
                clickListener: function() {
                  ...
                  i.data("spaceSelect", !1),
                    ...
                    this.$newElement.on("show.bs.dropdown", (function() {
                        t.dropdown || "4" !== V.major || (t.dropdown = t.$button.data("bs.dropdown"),
                    ...
                    this.$button.on("click.bs.dropdown.data-api", (function(e) {
                        if (t.options.allowClear) {
                          ...
                          i !== s && i.parentElement !== s || (e.stopImmediatePropagation(),
                            function(e) {
                              if (t.multiple)
                                t.deselectAll();
                              else {
                              ...
                              t.$newElement.hasClass(G.SHOW) && (t.options.liveSearch && t.$searchbox.trigger("focus"),
                                t.createView(!1))
                            }())
                        }
                    ...
                    this.$element.on("shown" + F, (function() {
                        t.$menuInner[0].scrollTop !== t.selectpicker.view.scrollTop && (t.$menuInner[0].scrollTop = t.selectpicker.view.scrollTop),
                          V.major > 3 ? requestAnimationFrame(n) : s()
                      }
                    )),
                    ...
                    this.$menuInner.on("click", "li a", (function(i, s) {
                        ...
                        !t.isDisabled() && !n.parent().hasClass(G.DISABLED)) {
                          var f = r.option
                            ...
                            , y = I instanceof Element ? J.fromOption : J.fromDataSource
                            , x = I && I.children
                            , E = parseInt(t.options.maxOptions)
                            , $ = I && parseInt(y(I, "maxOptions")) || !1;
                          if (a === t.activeElement && (s = !0),
                          s || (t.prevActiveElement = t.activeElement,
                            t.activeElement = void 0),
                          t.multiple && 1 !== E) {
                            if (t.setSelected(r, !b),
                              t.focusedParent.focus(),
                            !1 !== E || !1 !== $) {
                              var S = E < v.call(t).length
                                , C = 0;
                              if (I && I.children)
                                for (var O = 0; O < I.children.length; O++)
                                  I.children[O].selected && C++;
                              var A = $ < C;
                              if (E && S || $ && A)
                                if (E && 1 === E)
                                  o.selectedIndex = -1,
                                  ...
                                  D[2] && (L = L.replace("{var}", D[2][E > 1 ? 0 : 1]),
                                    N = N.replace("{var}", D[2][$ > 1 ? 0 : 1])),
                                    t.$menu.append(H),
                                  E && S && (H.append(e("<div>" + L + "</div>")),
                                    u = !1,
                                    t.$element.trigger("maxReached" + F)),
                                  $ && A && (H.append(e("<div>" + N + "</div>")),
                                    u = !1,
                                    t.$element.trigger("maxReachedGrp" + F)),
                                    setTimeout((function() {
                                        t.setSelected(r, !1)
                                      }
                                    ), 10),
                                    H[0].classList.add("fadeOut"),
                                    setTimeout((function() {
                                        H.remove()
                                      }
                                    ), 1050)
                          ...
                          u && (t.multiple || d !== o.selectedIndex) && (w = [f.index, m.prop("selected"), c],
                            t.$element.triggerNative("change"))
                        }
                      }
                    )),
                  ...
                  this.$button.on("click.bs.dropdown.data-api", (function() {
                    ...
                    this.$searchbox.on("input propertychange", (function() {
                        ...
                        if (e.selectpicker.search.elements = [],
                          ...
                          t)
                          if (e.selectpicker.search.previousValue = t,
                            e.options.source.search)
                            ...
                            for (var a = 0; a < e.selectpicker.main.data.length; a++) {
                              ...
                              n[a] || (n[a] = I(c, s, l, r)),
                              n[a] && void 0 !== c.headerIndex && -1 === o.indexOf(c.headerIndex) && (c.headerIndex > 0 && (n[c.headerIndex - 1] = !0,
                            ...
                            for (var d = o.length; a < d; a++) {
                              var h = o[a]
                                , p = o[a - 1]
                                , u = (c = e.selectpicker.main.data[h],
                                e.selectpicker.main.data[p]);
                              ("divider" !== c.type || "divider" === c.type && u && "divider" !== u.type && d - 1 !== a) && (e.selectpicker.search.data.push(c),
                                i.push(e.selectpicker.main.elements[h]))
                            }
                            e.activeElement = void 0,
                              e.noScroll = !0,
                              e.$menuInner.scrollTop(0),
                ...
                val: function(e) {
                  ...
                  if (void 0 !== e) {
                    ...
                    this.options.source.data && t.appendChild(this.selectpicker.main.optionQueue),
                      this.$element.trigger("changed" + F, w),
                ...
                keydown: function(t) {
                  var i, s, n, o, l, r = e(this), a = r.hasClass("dropdown-toggle"), c = (a ? r.closest(".dropdown") : r.closest(q.MENU)).data("this"), d = c.findLis(), h = !1, p = t.which === W && !a && !c.options.selectOnTab, u = Q.test(t.which) || p, f = c.$menuInner[0].scrollTop, m = !0 === c.isVirtual() ? c.selectpicker.view.position0 : 0;
                  if (!(t.which >= 112 && t.which <= 123))
                    if (!(s = c.$menu.hasClass(G.SHOW)) && (u || t.which >= 48 && t.which <= 57 || t.which >= 96 && t.which <= 105 || t.which >= 65 && t.which <= 90) && (c.$button.trigger("click.bs.dropdown.data-api"),
                      c.options.liveSearch))
                      c.$searchbox.trigger("focus");
                    else {
                      if (t.which === H && s && (t.preventDefault(),
                        c.$button.trigger("click.bs.dropdown.data-api").trigger("focus")),
                        u) {
                        if (!d.length)
                          return;
                        -1 !== (i = (n = c.activeElement) ? Array.prototype.indexOf.call(n.parentElement.children, n) : -1) && c.defocusItem(n),
                          t.which === B ? (-1 !== i && i--,
                          i + m < 0 && (i += d.length),
                          c.selectpicker.view.canHighlight[i + m] || -1 === (i = c.selectpicker.view.canHighlight.slice(0, i + m).lastIndexOf(!0) - m) && (i = d.length - 1)) : (t.which === R || p) && (++i + m >= c.selectpicker.view.canHighlight.length && (i = c.selectpicker.view.firstHighlightIndex),
                          c.selectpicker.view.canHighlight[i + m] || (i = i + 1 + c.selectpicker.view.canHighlight.slice(i + m + 1).indexOf(!0))),
                          t.preventDefault();
                        var v = m + i;
                        t.which === B ? 0 === m && i === d.length - 1 ? (c.$menuInner[0].scrollTop = c.$menuInner[0].scrollHeight,
                          v = c.selectpicker.current.elements.length - 1) : (o = c.selectpicker.current.data[v]) && (h = (l = o.position - o.height) < f) : (t.which === R || p) && (i === c.selectpicker.view.firstHighlightIndex ? (c.$menuInner[0].scrollTop = 0,
                          v = c.selectpicker.view.firstHighlightIndex) : (o = c.selectpicker.current.data[v]) && (h = (l = o.position - c.sizeInfo.menuInnerHeight) > f)),
                          n = c.selectpicker.current.elements[v],
                          c.activeElement = (c.selectpicker.current.data[v] || {}).element,
                          c.focusItem(n),
                      ...
                      } else if (!r.is("input") && !Y.test(t.which) || t.which === P && c.selectpicker.keydown.keyHistory) {
                        var g, b, w = [];
                        t.preventDefault(),
                        ...
                        for (var k = 0; k < c.selectpicker.current.data.length; k++) {
                          var y = c.selectpicker.current.data[k];
                          I(y, b, "startsWith", !0) && c.selectpicker.view.canHighlight[k] && w.push(y.element)
                        }
                        if (w.length) {
                          var x = 0;
                          d.removeClass("active").find("a").removeClass("active"),
                          1 === b.length && (-1 === (x = w.indexOf(c.activeElement)) || x === w.length - 1 ? x = 0 : x++),
                            g = w[x],
                            f - (o = c.selectpicker.main.data[g]).position > 0 ? (l = o.position - o.height,
                              h = !0) : (l = o.position - c.sizeInfo.menuInnerHeight,
                      ...
                      s && (t.which === P && !c.selectpicker.keydown.keyHistory || t.which === M || t.which === W && c.options.selectOnTab) && (t.which !== P && t.preventDefault(),
                      c.options.liveSearch && t.which === P || (c.$menuInner.find(".active a").trigger("click", !0),
                        r.trigger("focus"),
                ...
                destroy: function() {
                  ...
                  this.selectpicker.view.titleOption && this.selectpicker.view.titleOption.parentNode && this.selectpicker.view.titleOption.parentNode.removeChild(this.selectpicker.view.titleOption),
                    this.$element.off(F).removeData("selectpicker").removeClass("bs-select-hidden selectpicker mobile-device"),
                    e(window).off(F + "." + this.selectId)
                }
              };
            var se = e.fn.selectpicker;
            function ne() {
              return V.major < 5 ? e.fn.dropdown ? (e.fn.dropdown.Constructor._dataApiKeydownHandler || e.fn.dropdown.Constructor.prototype.keydown).apply(this, arguments) : void 0 : j.dataApiKeydownHandler
            }
            e.fn.selectpicker = ie,
              e.fn.selectpicker.Constructor = te,
              e.fn.selectpicker.noConflict = function() {
                return e.fn.selectpicker = se,
                  this
              }
              ,
