          ...
          t.exports = function() {
            ...
            function c() {
              ...
              for (let i of arguments)
                for (let s of i)
                  g(s) ? e[s.value] || (t.push(s),
                    e[s.value] = 1) : t.includes(s) || t.push(s);
              return t
            }
            function u(t) {
            ...
            function w(t, e, i) {
              return t ? (e && (t.__tagifyTagData = i ? e : p({}, t.__tagifyTagData || {}, e)),
                t.__tagifyTagData) : (console.warn("tag element doesn't exist", t, e),
                e)
            }
            function b(t) {
              if (t && t.parentNode) {
                var e = t
                  ...
                  , s = i.getRangeAt(0);
                i.rangeCount && (s.setStartAfter(e),
                  s.collapse(!0),
                  i.removeAllRanges(),
                  i.addRange(s))
              }
            ...
            var D = {
              ...
              show(t) {
                ...
                if (t = void 0 === t ? this.state.inputText : t,
                  !(r && !o && !n.templates.dropdownItemNoMatch || !1 === n.dropdown.enable || this.state.isLoading || this.settings.readonly)) {
                  ...
                  n.templates.dropdownItemNoMatch && (s = n.templates.dropdownItemNoMatch.call(this, {
                    value: t
                  }))),
                    !s) {
                    if (this.suggestedListItems.length)
                      t && o && !this.state.editing.scope && !a(this.suggestedListItems[0].value, t) && this.suggestedListItems.unshift({
                        value: t
                      });
                    else {
                    ...
                    i = "" + (g(e = this.suggestedListItems[0]) ? e.value : e),
                    n.autoComplete && i && 0 == i.indexOf(t) && this.input.autocomplete.suggest.call(this, e)
                  }
                  this.dropdown.fill(s),
                  n.dropdown.highlightFirst && this.dropdown.highlightOption(this.DOM.dropdown.content.querySelector(n.classNames.dropdownItemSelector)),
              ...
              render() {
                var t, e, i = ((e = this.DOM.dropdown.cloneNode(!0)).style.cssText = "position:fixed; top:-9999px; opacity:0",
                  document.body.appendChild(e),
                  t = e.clientHeight,
                  e.parentNode.removeChild(e),
                  t), s = this.settings;
                return "number" == typeof s.dropdown.enabled && s.dropdown.enabled >= 0 ? (this.DOM.scope.setAttribute("aria-expanded", !0),
                document.body.contains(this.DOM.dropdown) || (this.DOM.dropdown.classList.add(s.classNames.dropdownInital),
                  this.dropdown.position(i),
                  s.dropdown.appendTarget.appendChild(this.DOM.dropdown),
                  setTimeout((()=>this.DOM.dropdown.classList.remove(s.classNames.dropdownInital)))),
                  this) : this
              },
              fill(t) {
                ...
                if ("manual" != e.position) {
                  ...
                  if (t = t || l.clientHeight,
                    ...
                    s = Math.floor(s),
                      ...
                      l.style.cssText = "left:" + (n + window.pageXOffset) + "px; width:" + o + ";" + (d ? "top: " + (s + g) + "px" : "top: " + (a + g) + "px"),
              ...
              events: {
                binding() {
                  ...
                  "manual" != this.settings.dropdown.position && (document[s]("scroll", i.position, !0),
                    ...
                    if (this.state.hasFocus && !this.state.composing) {
                      ...
                      switch (t.key) {
                        ...
                        case "Up":
                          ...
                          e && e.matches(this.settings.classNames.dropdownItemSelector) || (e = s[a ? s.length - 1 : 0]),
                        ...
                        case "Tab":
                          if ("mix" != this.settings.mode && e && !this.settings.autoComplete.rightKey && !this.state.editing) {
                            ...
                            return this.input.autocomplete.set.call(this, n),
                              !1
                          }
                          return !0;
                        case "Enter":
                          t.preventDefault(),
                            this.settings.hooks.suggestionClick(t, {
                              ...
                              suggestionElm: e
                                ...
                                if (e)
                                  return this.dropdown.selectOption(e),
                                    e = this.dropdown.getNextOrPrevOption(e, !a),
                                    void this.dropdown.highlightOption(e);
                                this.dropdown.hide(),
              ...
              highlightOption(t, e) {
                ...
                if (this.state.ddItemElm && (this.state.ddItemElm.classList.remove(s),
              ...
              selectOption(t, e) {
                ...
                this.trigger("dropdown:select", {
                  ...
                  n && (r || o) ? (this.state.editing ? this.onEditTagDone(null, p({
                    __isValid: !0
                  }, this.normalizeTags([r])[0])) : this["mix" == this.settings.mode ? "addMixTags" : "addTags"]([r || this.input.raw.call(this)], s),
              ...
              filterListItems(t, e) {
                var i, s, a, n, o, r = this.settings, l = r.dropdown, d = (e = e || {},
                  []), h = [], p = r.whitelist, c = l.maxItems >= 0 ? l.maxItems : 1 / 0, m = l.searchKeys, v = 0;
                if (!(t = "select" == r.mode && this.value.length && this.value[0][r.tagTextProp] == t ? "" : t) || !m.length)
                  return d = l.includeSelectedTags ? p : p.filter((t=>!this.isTagDuplicate(g(t) ? t.value : t))),
                ...
                for (o = l.caseSensitive ? "" + t : ("" + t).toLowerCase(); v < p.length; v++) {
                  ...
                  let c = Object.keys(i).some((t=>m.includes(t))) ? m : ["value"];
                  l.fuzzySearch && !e.exact ? (a = c.reduce(((t,e)=>t + " " + (i[e] || "")), "").toLowerCase().trim(),
                  l.accentedSearch && (a = u(a),
                    o = u(o)),
                    t = 0 == a.indexOf(o),
                    r = a === o,
                    s = f(a, o)) : (t = !0,
                    ...
                    n = !l.includeSelectedTags && this.isTagDuplicate(g(i) ? i.value : i),
                  s && !n && (r && t ? h.push(i) : "startsWith" == l.sortby && t ? d.unshift(i) : d.push(i))
                }
                return this.state.dropdown.suggestions = h.concat(d),
                  "function" == typeof l.sortby ? l.sortby(h.concat(d), o) : h.concat(d).slice(0, c)
              },
              getMappedValue(t) {
              ...
              createListHTML(t) {
                return p([], t).map(((t,i)=>{
                    ...
                    return s = "string" == typeof s ? h(s) : s,
                      this.settings.templates.dropdownItem.apply(this, [e(e({}, t), {}, {
                        mappedValue: s
                      }), this])
                  }
                )).join("")
              ...
              binding() {
                ...
                if (!this.state.mainEvents || !t) {
                  ...
                  clearInterval(this.listeners.main.originalInputValueObserverInterval),
                    this.listeners.main.originalInputValueObserverInterval = setInterval(i.observeOriginalInputValue.bind(this), 500);
                  var n = this.listeners.main.inputMutationObserver || new MutationObserver(i.onInputDOMChange.bind(this));
                  n.disconnect(),
                  "mix" == this.settings.mode && n.observe(this.DOM.input, {
                    childList: !0
                  })
                }
              },
              ...
              callbacks: {
                onFocusBlur(t) {
                  ...
                  if ("blur" == a) {
                    ...
                    this.postUpdate(),
                    e.onChangeAfterBlur && this.triggerChangeEvent()
                  }
                  if (!r && !l)
                    if (this.state.hasFocus = "focus" == a && +new Date,
                      this.toggleFocusClass(this.state.hasFocus),
                    "mix" != e.mode) {
                      if ("focus" == a)
                        return this.trigger("focus", o),
                          void (0 !== e.dropdown.enabled && e.userInput || this.dropdown.show(this.value.length ? "" : void 0));
                      "blur" == a && (this.trigger("blur", o),
                        this.loading(!1),
                      "select" == e.mode && (d && (this.removeTags(),
                        i = ""),
                      s === i && (i = "")),
                      i && !this.state.actions.selectOption && e.addTagOnBlur && this.addTags(i, !0)),
                        this.DOM.input.removeAttribute("style"),
                        this.dropdown.hide()
                    } else
                      "focus" == a ? this.trigger("focus", o) : "blur" == t.type && (this.trigger("blur", o),
                        this.loading(!1),
                        this.dropdown.hide(),
                ...
                onWindowKeyDown(t) {
                  ...
                  if (s && !a)
                    switch (e = i.nextElementSibling,
                      t.key) {
                      case "Backspace":
                        this.settings.readonly || (this.removeTags(i),
                ...
                onKeydown(t) {
                  ...
                  if (!this.state.composing && e.userInput) {
                    ...
                    "mix" == e.mode) {
                      switch (t.key) {
                        ...
                        case "Backspace":
                          ...
                          if ("edit" == e.backspace && o)
                            return l = 1 == s.anchorNode.nodeType ? null : s.anchorNode.previousElementSibling,
                              setTimeout(this.editTag.bind(this), 0, l),
                              void t.preventDefault();
                          if (m() && o instanceof Element)
                            return g = d(o),
                          ...
                          if ("BR" == s.anchorNode.nodeName)
                            return;
                          if ((a || o) && 1 == s.anchorNode.nodeType ? h = 0 == s.anchorOffset ? a ? p[0] : null : p[Math.min(p.length, s.anchorOffset) - 1] : a ? h = s.anchorNode.nextElementSibling : o instanceof Element && (h = o),
                          3 == s.anchorNode.nodeType && !s.anchorNode.nodeValue && s.anchorNode.previousElementSibling && t.preventDefault(),
                          (o || a) && !e.backspace)
                            return void t.preventDefault();
                          if ("Range" != s.type && !s.anchorOffset && s.anchorNode == this.DOM.input && "Delete" != t.key)
                            return void t.preventDefault();
                          if ("Range" != s.type && h && h.hasAttribute("readonly"))
                            return void b(d(h));
                          "Delete" == t.key && c && w(s.anchorNode.nextSibling) && this.removeTags(s.anchorNode.nextSibling),
                            clearTimeout(I),
                            I = setTimeout((()=>{
                                var t = document.getSelection();
                                r(this.DOM.input.innerHTML),
                                !a && t.anchorNode.previousSibling,
                                  this.value = [].map.call(p, ((t,e)=>{
                                      var i = w(t);
                    ...
                    switch (t.key) {
                      ...
                      case "Enter":
                        if (this.state.dropdown.visible && "manual" != e.dropdown.position)
                          return;
                        t.preventDefault(),
                          setTimeout((()=>{
                ...
                onInput(t) {
                  ...
                  this.state.inputText != i && (this.input.set.call(this, i, !1),
                    -1 != i.search(e.delimiters) ? this.addTags(i) && this.input.set.call(this) : e.dropdown.enabled >= 0 && this.dropdown[s ? "show" : "hide"](i),
                    this.trigger("input", a))
                },
                onMixTagsInput(t) {
                  var e, i, s, a, n, o, r, l, d = this.settings, h = this.value.length, g = this.getTagElms(), c = document.createDocumentFragment(), u = window.getSelection().getRangeAt(0), v = [].map.call(g, (t=>w(t).value));
                  ...
                  c.childNodes.length && (u.insertNode(c),
                    this.setRangeAtStartEnd(!1, c.lastChild)),
                  g.length != h)
                    return this.value = [].map.call(this.getTagElms(), (t=>w(t))),
                      void this.update({
                  ...
                  if (window.getSelection && (o = window.getSelection()).rangeCount > 0 && 3 == o.anchorNode.nodeType) {
                    if ((u = o.getRangeAt(0).cloneRange()).collapse(!0),
                      u.setStart(o.focusNode, 0),
                      s = (e = u.toString().slice(0, u.endOffset)).split(d.pattern).length - 1,
                    (i = e.match(d.pattern)) && (a = e.slice(e.lastIndexOf(i[i.length - 1]))),
                      a) {
                      if (this.state.actions.ArrowLeft = !1,
                        ...
                        return this.state.tag.value = this.state.tag.value.replace(d.delimiters, ""),
                ...
                onClickScope(t) {
                  ...
                  if (t.target != this.DOM.scope) {
                    if (!t.target.classList.contains(e.classNames.tagX))
                      ...
                      s > 500) ? this.state.dropdown.visible ? this.dropdown.hide() : 0 === e.dropdown.enabled && "mix" != e.mode && this.dropdown.show(this.value.length ? "" : void 0) : "select" != e.mode || 0 !== e.dropdown.enabled || this.state.dropdown.visible || this.dropdown.show());
                ...
                onPaste(t) {
                  ...
                  if ("select" == s.mode && s.enforceWhitelist || !s.userInput)
                    return !1;
                  s.readonly || (e = t.clipboardData || window.clipboardData,
                    i = e.getData("Text"),
                    s.hooks.beforePaste(t, {
                      ...
                      clipboardData: e
                        ...
                        void 0 === e && (e = i),
                        e && (this.injectAtCaret(e, window.getSelection().getRangeAt(0)),
                ...
                onEditTagInput(t, e) {
                  ...
                  this.editTagChangeDetected(p(a, o)) || !0 !== t.originalIsValid || (r = !0),
                    i.classList.toggle(this.settings.classNames.tagInvalid, !0 !== r),
                    a.__isValid = r,
                    i.title = !0 === r ? a.title || a.value : r,
                  n.length >= this.settings.dropdown.enabled && (this.state.editing && (this.state.editing.value = n),
                ...
                onEditTagBlur(t) {
                  if (this.state.hasFocus || this.toggleFocusClass(),
                    ...
                    var e, i, s = this.settings, a = t.closest("." + s.classNames.tag), n = w(a), o = this.input.normalize.call(this, t), r = {
                      [s.tagTextProp]: o,
                      __tagId: n.__tagId
                    }, l = n.__originalData, d = this.editTagChangeDetected(p(n, r)), h = this.validateTag(r);
                    if (o)
                      if (d) {
                        if (e = this.hasMaxTags(),
                          i = p({}, l, {
                            [s.tagTextProp]: this.trim(o),
                            __isValid: h
                          }),
                          s.transformTag.call(this, i, l),
                        !0 !== (h = (!e || !0 === l.__isValid) && this.validateTag(i))) {
                          ...
                          s.keepInvalidTags && (delete i.title,
                ...
                onDoubleClickScope(t) {
                  var e, i, s = t.target.closest("." + this.settings.classNames.tag), a = w(s), n = this.settings;
                  s && n.userInput && !1 !== a.editable && (e = s.classList.contains(this.settings.classNames.tagEditing),
                    i = s.hasAttribute("readonly"),
                  "select" == n.mode || n.readonly || e || i || !this.settings.editTags || this.editTag(s),
                    this.toggleFocusClass(!0),
                      ...
                      t.addedNodes.forEach((t=>{
                          if ("<div><br></div>" == t.outerHTML)
                            ...
                            3 == t.childNodes[0].nodeType && "BR" != t.previousSibling.nodeName && (e = document.createTextNode("\n")),
                              ...
                              b(e)
                          } else if (f.call(this, t))
                            if (3 != t.previousSibling?.nodeType || t.previousSibling.textContent || t.previousSibling.remove(),
                            t.previousSibling && "BR" == t.previousSibling.nodeName) {
                              ...
                              t.previousSibling && !w(t.previousSibling) || t.before(s)
                        }
                      )),
                        t.removedNodes.forEach((t=>{
                            t && "BR" == t.nodeName && f.call(this, e) && (this.removeTags(e),
            ...
            function E(t, e) {
              ...
              if (t.__tagify)
                return console.warn("Tagify: ", "input element is already Tagified - Same instance is returned.", t),
                  t.__tagify;
              var i;
              p(this, function(t) {
                ...
                return {
                  ...
                  on(t, e) {
                    return e && "function" == typeof e && i("add", t, e),
                      this
                  },
                  trigger(i, s, a) {
                    var n;
                    if (a = a || {
                      ...
                      if (t.settings.isJQueryPlugin)
                        ...
                        try {
                          ...
                          if ((o = a.cloneData ? p({}, o) : o).tagify = this,
                          s.event && (o.event = this.cloneEvent(s.event)),
                          s instanceof Object)
                            for (var r in s)
                ...
                e = e || {},
                this.getPersistedData = (i = e.id,
                    t=>{
                      let e, s = "/" + t;
                      if (1 == localStorage.getItem(M + i + "/v", 1))
                        try {
                ...
                this.setPersistedData = (t=>t ? (localStorage.setItem(M + t + "/v", 1),
                      (e,i)=>{
                        let s = "/" + i
                          , a = JSON.stringify(e);
                        e && i && (localStorage.setItem(M + t + s, a),
            ...
            return E.prototype = {
              ...
              applySettings(t, i) {
                ...
                if (a.disabled = t.hasAttribute("disabled"),
                  ...
                  a.placeholder = h(t.getAttribute("placeholder") || a.placeholder || ""),
                ...
                "autoComplete"in i && !g(i.autoComplete) && (a.autoComplete = x.autoComplete,
                  a.autoComplete.enabled = i.autoComplete),
                "mix" == a.mode && (a.pattern = a.pattern || /@/,
                  a.autoComplete.rightKey = !0,
                  a.delimiters = i.delimiters || null,
                ...
                a.disabled && (a.userInput = !1),
                  this.TEXTS = e(e({}, N), a.texts || {}),
                ("select" != a.mode || i.dropdown?.enabled) && a.userInput || (a.dropdown.enabled = 0),
                  a.dropdown.appendTarget = i.dropdown?.appendTarget || document.body;
              ...
              getCustomAttributes(t) {
                ...
                var e, i = {};
                for (e in t)
                  "__" != e.slice(0, 2) && "class" != e && t.hasOwnProperty(e) && void 0 !== t[e] && (i[e] = h(t[e]));
                return i
              },
              setStateSelection() {
                ...
                if (s) {
                  if (!(n instanceof Object && "editable"in n) || n.editable)
                    return n = w(t, {
                      ...
                      w(n.__originalHTML, n.__originalData),
                      ...
                      s.addEventListener("keydown", (e=>o.onEditTagkeydown.call(this, e, t))),
                    ...
                    e.skipValidation || (l = this.editTagToggleValidity(t)),
                      s.originalIsValid = l,
              ...
              onEditTagDone(t, e) {
                ...
                this.trigger("edit:beforeUpdate", i, {
                  ...
                  t && e[this.settings.tagTextProp] ? (t = this.replaceTag(t, e),
                    this.editTagToggleValidity(t, e),
                    this.settings.a11y.focusableTags ? t.focus() : b(t)) : t && this.removeTags(t),
              ...
              replaceTag(t, e) {
                ...
                e.__isValid && 1 != e.__isValid && p(e, this.getInvalidTagAttrs(e, e.__isValid));
              ...
              injectAtCaret(t, e) {
                return !(e = e || this.state.selection?.range) && t ? (this.appendMixTags(t),
                  this) : (T(t, e),
              ...
              input: {
                set() {
                  ...
                  e && (this.DOM.input.innerHTML = h("" + t)),
              ...
              isTagBlacklisted(t) {
                return t = this.trim(t.toLowerCase()),
                  this.settings.blacklist.filter((e=>("" + e).toLowerCase() == t)).length
              },
              isTagWhitelisted(t) {
              ...
              getWhitelistItem(t, e, i) {
                ...
                return (i = i || n.whitelist).some((i=>{
                    ...
                    if (a(o, t, n.dropdown.caseSensitive, n.trim))
                      return s = "string" == typeof i ? {
                        value: i
                      } : i,
                        !0
                  }
                )),
                s || "value" != e || "value" == n.tagTextProp || (s = this.getWhitelistItem(t, n.tagTextProp, i)),
                  s
              },
              validateTag(t) {
                var e = this.settings
              ...
              setContentEditable(t) {
                this.settings.userInput && (this.DOM.input.contentEditable = t,
              ...
              normalizeTags(t) {
                ...
                "string" == typeof t) {
                  ...
                  l && (t = [].concat(...t.map((t=>null != t.value ? t : h(t)))));
              ...
              parseMixTags(t) {
                ...
                t = t.split(i[0]).map(((t,e)=>{
                    ...
                    if (a.call(this, h),
                    u || !(p.length > 1) || n && !this.isTagWhitelisted(h.value) || !s && this.isTagDuplicate(h.value)) {
                      if (t)
                        return e ? i[0] + t : t
                    } else
                ...
                return d.forEach(((t,e)=>w(t, l[e]))),
                  this.update({
                    withoutChangeEvent: !0
                  }),
                  y(d, this.state.hasFocus),
                  t
              },
              replaceTextWithNode(t, e) {
                if (this.state.tag || e) {
                  ...
                  return n.splitText(a.anchorOffset - o),
                  -1 == (i = n.nodeValue.lastIndexOf(e)) || (s = n.splitText(i),
              ...
              selectTag(t, e) {
                ...
                if (!i.enforceWhitelist || this.isTagWhitelisted(e.value)) {
                  ...
                  return s ? this.replaceTag(s, e) : this.appendTag(t),
                    this.value[0] = e,
                    this.update(),
                    this.trigger("add", {
                      tag: t,
              ...
              addTags(t, e, i) {
                ...
                return this.DOM.input.removeAttribute("style"),
                  t.forEach((t=>{
                      var e, r = {}, l = Object.assign({}, t, {
                        value: t.value + ""
                      });
                      if (t = Object.assign({}, l),
                      ...
                      if ("readonly"in t && (t.readonly ? r["aria-readonly"] = !0 : delete t.readonly),
                        e = this.createTagElem(t, r),
                        s.push(e),
                      "select" == a.mode)
                        return this.selectTag(e, t);
                      o.appendChild(e),
                        t.__isValid && !0 === t.__isValid ? (this.value.push(t),
                          this.trigger("add", {
                            tag: e,
                        ...
                        a.keepInvalidTags || setTimeout((()=>this.removeTags(e, !0)), 1e3)),
                        this.dropdown.position()
                    }
                  )),
                  this.appendTag(o),
                  this.update(),
                t.length && e && (this.input.set.call(this, a.createInvalidTags ? "" : n.join(a._delimiters)),
                  this.setRangeAtStartEnd(!1, this.DOM.input)),
              ...
              prefixedTextToTag(t) {
                ...
                if (i.transformTag.call(this, t),
                  t.prefix = t.prefix || this.state.tag ? this.state.tag.prefix : (i.pattern.source || i.pattern)[0],
              ...
              reCheckInvalidTags() {
                ...
                this.getTagElms(t.classNames.tagNotAllowed).forEach(((e,i)=>{
                    var s = w(e)
                      ...
                      , o = !0 === n && !a;
                    if ("select" == t.mode && this.toggleScopeValidation(n),
                      o)
              ...
              removeTags(t, e, i) {
                ...
                1 == s.length && "select" != a.mode && s[0].node.classList.contains(a.classNames.tagNotAllowed) && (e = !0),
                  s.length)
                  return a.hooks.beforeRemoveTag(s, {
                    tagify: this
                  }).then((()=>{
                      function t(t) {
                      ...
                      i && i > 10 && 1 == s.length ? function(e) {
                        ...
                        .call(this, s[0]) : s.forEach(t.bind(this)),
                      e || (this.removeTagsFromValue(s.map((t=>t.node))),
                        this.update(),
                      "select" == a.mode && this.setContentEditable(!0))
                    }
                  )).catch((t=>{}
                  ))
              },
                  ...
                  n.childNodes.forEach((n=>{
                      if (1 == n.nodeType) {
                        ...
                        r && f.call(e, n)) {
                          ...
                          n.getAttribute("style") || ["B", "I", "U"].includes(n.tagName) ? t += n.textContent : "DIV" != n.tagName && "P" != n.tagName || (t += "\r\n",
                            i(n))
                      } else
                        t += n.textContent
                    }
              ...
              E.prototype.removeTag = E.prototype.removeTags,
              E
          }()
        }
      }
