      ...
      var e = {
        27082: function(e) {
          e.exports = function() {
            ...
            function r() {
              if (window.Element.prototype.matches || (t = window.Element.prototype.msMatchesSelector || window.Element.prototype.webkitMatchesSelector),
              window.Element.prototype.closest || (n = function(e, n) {
            ...
            var o = 1e3
              ...
              , u = function(e, t, n, s) {
              var r = e[l];
              if (!r._steps[t].classList.contains(c.ACTIVE) && !r._stepsContents[t].classList.contains(c.ACTIVE)) {
                var o = i("show.bs-stepper", {
                  cancelable: !0,
                  detail: {
                    from: r._currentIndex,
                    to: t,
                    indexStep: t
                  }
                });
                ...
                o.defaultPrevented || (a.length && a[0].classList.remove(c.ACTIVE),
                u.length && (u[0].classList.remove(c.ACTIVE),
                e.classList.contains(c.VERTICAL) || r.options.animation || u[0].classList.remove(c.BLOCK)),
              ...
              n.forEach((function(t) {
                  ...
                  e.classList.contains(c.LINEAR) && n.setAttribute("disabled", "disabled")
                }
              )),
                t.classList.add(c.ACTIVE);
              var i = t.querySelector(s.selectors.trigger);
              i.setAttribute("aria-selected", "true"),
              e.classList.contains(c.LINEAR) && i.removeAttribute("disabled")
            }
              ...
              e.addEventListener(a, r),
                window.setTimeout((function() {
                    n || e.dispatchEvent(s(a)),
                      e.removeEventListener(a, r)
                  }
                ), i)
            }
              , h = function(e, t) {
              t.animation && e.forEach((function(e) {
                  e.classList.add(c.FADE),
                    e.classList.add(c.NONE)
                }
              ))
            }
              , L = function() {
            ...
            return function() {
              function t(t, n) {
                ...
                void 0 === n && (n = {}),
                  ...
                  this._stepsContents = [],
                  this.options = e({}, _, {}, n),
                  this.options.selectors = e({}, _.selectors, {}, this.options.selectors),
                this.options.linear && this._element.classList.add(c.LINEAR),
                  this._steps = [].slice.call(this._element.querySelectorAll(this.options.selectors.steps)),
                  this._steps.filter((function(e) {
                      return e.hasAttribute("data-target")
                    }
                  )).forEach((function(e) {
                      s._stepsContents.push(s._element.querySelector(e.getAttribute("data-target")))
                    }
                  )),
                ...
                this._steps.length && u(this._element, this._currentIndex, this.options, (function() {}
                ))
              }
              var n = t.prototype;
              return n._setLinkListeners = function() {
                var e = this;
                this._steps.forEach((function(t) {
                    var n = t.querySelector(e.options.selectors.trigger);
                    e.options.linear ? (e._clickStepLinearListener = L(e.options),
                      n.addEventListener("click", e._clickStepLinearListener)) : (e._clickStepNonLinearListener = E(e.options),
                      n.addEventListener("click", e._clickStepNonLinearListener))
                  }
                ))
              }
                ,
        ...
        document.querySelectorAll(".bs-stepper").forEach((function(e) {
            e.addEventListener("show.bs-stepper", (function(t) {
                for (var n = t.detail.indexStep, s = e.querySelectorAll(".line").length, i = e.querySelectorAll(".step"), r = 0; r < n; r++) {
                  ...
                  for (var o = n; o < s; o++)
                    i[o].classList.remove("crossed")
                }
                if (0 == t.detail.to) {
                  for (var c = n; c < s; c++)
                    i[c].classList.remove("crossed");
