...
// donated
Route::get('/donated/voluntary', [App\Http\Controllers\DonorController::class, 'bindVoluntary'])->name('donated-bind-voluntary');
Route::get('/donated/voluntary/history', [App\Http\Controllers\DonorController::class, 'indexVoluntaryHistory'])->name('donated-voluntary-history');
Route::get('/donated/food-parcel', [App\Http\Controllers\DonorController::class, 'indexFoodParcel'])->name('donated-food-parcel');
Route::get('/donated/bazaar', [App\Http\Controllers\DonorController::class, 'indexBazaar'])->name('donated-bazaar');

// user
Route::get('/user/list', [App\Http\Controllers\UserController::class, 'index'])->name('user-list');
Route::get('/user/new', [App\Http\Controllers\UserController::class, 'store'])->name('user-new');
Route::get('/user/office', [App\Http\Controllers\UserController::class, 'indexOffice'])->name('user-office');
Route::get('/user/role', [App\Http\Controllers\UserController::class, 'indexRole'])->name('user-role');
